...
dagshub.init(repo_owner='khadar190798', 
             repo_name='Swiggy-Delivery-Time-Estimation', 
             mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/Khadar190798/my-first-repo.mlflow/")
